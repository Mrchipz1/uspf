...
$container[App\Controllers\UserAuthController::class] = function ($c) {
    return new App\Controllers\UserAuthController(
        $c->get('view'), 
        $c->get('logger'), 
        $c->get('db'), 
        $c->get('session'),
...
$container[App\Controllers\paymentprocess::class] = function ($c) {
    return new App\Controllers\paymentprocess(
        $c->get('view'), 
        $c->get('logger'), 
        $c->get('db'),
        $c->get('session'),

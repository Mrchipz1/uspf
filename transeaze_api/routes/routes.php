...
$app->group('/v1', function () use ($app) {
    ...
    $app->group('/clients', function () use ($app){
        $app->get('/test', App\Controllers\UserAuthController::class . ':test');
    ...
    $app->group('/paymentProcess', function () use ($app){
        $app->get('/test', App\Controllers\paymentprocess::class . ':test');
        $app->post('/verifyUser', App\Controllers\paymentprocess::class . ':verifyUser');
        $app->post('/getBankdetails', App\Controllers\paymentprocess::class . ':getBankProps');
    });
});
